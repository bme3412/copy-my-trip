import type { FinishedDay } from '../types'

/* `desc` supports *italics* between asterisks. */
export const CURATED_DAYS: FinishedDay[] = [
  {
    index: 1,
    title: 'Marais & the two islands',
    verifiedLabel: '6 of 8 stops personally verified',
    stops: [
      {
        time: '9:15',
        timeNote: 'morning',
        ...
        provenance: 'From 5 visits · last May 2024',
        transitAfter: { min: 3, measured: true },
      },
      {
        time: '9:45',
        ...
        provenance: 'From 7 visits · last May 2024',
        transitAfter: { min: 6, measured: false },
      },
      {
        time: '10:30',
        ...
        transitAfter: { min: 5, measured: true },
      },
      {
        time: '12:30',
        timeNote: 'lunch',
        ...
        provenance: 'From 4 visits · last May 2024',
        transitAfter: { min: 18, measured: false },
      },
      {
        time: '14:15',
        ...
        transitAfter: { min: 6, measured: true },
      },
      {
        time: '15:00',
        name: 'Berthillon',
        ...
        provenance: 'From 8 visits · last May 2024',
        ...
        transitAfter: { min: 9, measured: true },
      },
      {
        time: '19:40',
        timeNote: 'golden hour',
        name: 'Pont de la Tournelle',
        sub: 'back toward Notre-Dame',
        desc: 'End here. Stand on the bridge facing west about forty minutes before sunset — the light comes straight down the river. I have this shot from five different years.',
        kind: 'verified',
        plates: [
  ...
  {
    index: 2,
    title: 'Latin Quarter & the gardens',
    verifiedLabel: '5 of 7 stops personally verified',
    stops: [
      {
        time: '8:45',
        timeNote: 'morning',
        name: 'Café de la Mairie',
        sub: 'Place Saint-Sulpice, 6e',
        desc: 'Terrace coffee facing the fountain — sit on the square side, not the street side, and let the morning fill in.',
        kind: 'verified',
        plates: [
          { id: 'd2-cafe-1', w: 250, h: 168, caption: 'Terrace' },
          { id: 'd2-cafe-2', w: 170, h: 168, caption: 'Fountain' },
        ],
        provenance: 'From 4 visits · last Sep ’23',
        transitAfter: { min: 4, measured: false },
      },
      {
        time: '9:30',
        name: 'Église Saint-Sulpice',
        sub: 'the Delacroix murals · free',
        desc: 'Never shot the interior myself — added from web notes for the Delacroix chapel just inside the door.',
        kind: 'web-image',
        webImage: { id: 'd2-sulpice-1', caption: 'Interior (web reference)' },
        transitAfter: { min: 7, measured: true },
      },
      {
        time: '10:30',
        ...
        provenance: 'From 4 visits · last Sep ’23',
        transitAfter: { min: 12, measured: true },
      },
      {
        time: '12:30',
        timeNote: 'lunch',
        ...
        provenance: 'From 3 visits · last Sep ’23',
        transitAfter: { min: 6, measured: false },
      },
      {
        time: '14:15',
        name: 'Panthéon',
        sub: 'the dome & the crypt',
        desc: 'Outside my archive — placed here from web notes because the rooftop colonnade is worth the climb on a clear afternoon.',
        kind: 'web-pin',
        pin: 'Place du Panthéon',
        transitAfter: { min: 10, measured: true },
      },
      {
        time: '15:30',
        ...
        provenance: 'From 5 visits · last Sep ’23',
        transitAfter: { min: 4, measured: true },
      },
      {
        time: '18:30',
        timeNote: 'golden hour',
        name: 'Quai de Montebello',
        sub: 'the bouquinistes, facing Notre-Dame',
        desc: 'Walk the green book-boxes as the light drops — Notre-Dame across the water is the reason to end the day on this bank.',
        kind: 'verified',
        plates: [
          { id: 'd2-quai-1', w: 340, h: 190, caption: 'Booksellers & river' },
          { id: 'd2-quai-2', w: 150, h: 190, caption: 'Notre-Dame', video: '0:11' },
        ],
        provenance: 'From 4 visits · last Sep ’23',
      },
    ],
  ...
  {
    index: 3,
    title: 'Canal Saint-Martin & Montmartre',
    verifiedLabel: '4 of 7 stops personally verified',
    stops: [
      {
        time: '9:15',
        timeNote: 'morning',
      ...
      },
      {
        ...
        provenance: 'From 5 visits · last Sep ’23',
        transitAfter: { min: 15, measured: true },
      },
      {
        time: '11:30',
        name: 'Rue des Martyrs',
        sub: 'the climb toward Montmartre',
        desc: 'The best-fed street in Paris — take the slow uphill and let the food shops set the pace toward the hill.',
        kind: 'verified',
        plates: [
          { id: 'd3-martyrs-1', w: 250, h: 172, caption: 'Shopfronts' },
          { id: 'd3-martyrs-2', w: 180, h: 172, caption: 'Up the hill' },
        ],
        provenance: 'From 3 visits · last Apr ’22',
        transitAfter: { min: 5, measured: false },
      },
      {
        time: '13:00',
        timeNote: 'lunch',
        name: 'Le Bon Georges',
        sub: 'neighbourhood bistro, 9e',
        desc: "Not one of mine — picked from current notes as a sit-down lunch before the hill. Book ahead if it's a weekend.",
        kind: 'web-image',
        webImage: { id: 'd3-lunch-1', caption: 'Bistro (web reference)' },
        transitAfter: { min: 8, measured: false },
      },
      {
        time: '14:30',
        name: 'Sacré-Cœur',
        sub: 'the steps, not the summit crowd',
        desc: 'Sit on the steps below the basilica facing out — the view down over the city is better than the one from the very top.',
        kind: 'verified',
        plates: [
          { id: 'd3-sacre-1', w: 250, h: 172, caption: 'From the steps' },
          { id: 'd3-sacre-2', w: 180, h: 172, caption: 'The dome' },
        ],
        provenance: 'From 2 visits · last Apr ’19',
        transitAfter: { min: 4, measured: false },
      },
      {
        time: '15:30',
        timeNote: 'afternoon',
        name: 'Place du Tertre & the lanes',
        sub: 'Montmartre backstreets',
        desc: "A gap in my archive — added from web notes. Skip the painters' square itself and use it as a doorway into the quieter lanes behind.",
        kind: 'web-pin',
        pin: 'Place du Tertre, 18e',
      },
    ],
  },
  {
    index: 4,
    title: 'The east side & a last river light',
    verifiedLabel: '5 of 6 stops personally verified',
    stops: [
      {
        time: '9:30',
        timeNote: 'morning',
        ...
        provenance: 'From 3 visits · last Jun ’22',
        transitAfter: { min: 9, measured: true },
      },
      {
        time: '11:00',
        ...
        provenance: 'From 3 visits · last Jun ’22',
        transitAfter: { min: 7, measured: false },
      },
      {
        time: '13:00',
        timeNote: 'lunch',
      ...
      },
      {
        ...
        sub: 'the planted railway viaduct',
        desc: 'Walk the old rail line above the street — start at Bastille and let it carry you east through the rose arches, well above the traffic.',
        kind: 'verified',
        plates: [
          { id: 'd4-coulee-1', w: 250, h: 172, caption: 'The promenade' },
          { id: 'd4-coulee-2', w: 180, h: 172, caption: 'Rose arches' },
        ],
        provenance: 'From 2 visits · last Jun ’22',
        transitAfter: { min: 12, measured: true },
      },
      {
        time: '17:30',
        name: 'Place des Vosges',
        sub: 'back where Day 1 began',
        desc: 'Close the loop on the square that started the trip — a last turn under the arcades before the river.',
        kind: 'verified',
        plates: [
          { id: 'd4-vosges-1', w: 250, h: 172, caption: 'Arcades again' },
          { id: 'd4-vosges-2', w: 180, h: 172, caption: 'The garden' },
        ],
        provenance: 'From 7 visits · last May ’24',
        transitAfter: { min: 10, measured: true },
      },
      {
        time: '19:40',
        timeNote: 'golden hour',
        name: 'Pont de la Tournelle',
        sub: 'the last light of the trip',
        desc: 'End where Day 1 ended, on purpose — the same bridge, the same westward light, now with four days behind it.',
        kind: 'verified',
        plates: [
          { id: 'd4-tournelle-1', w: 340, h: 190, caption: 'River, last light' },
          { id: 'd4-tournelle-2', w: 150, h: 190, caption: 'Looking west', video: '0:24' },
        ],
        provenance: 'From 5 visits · last May ’24',
      },
    ],
  },
]
